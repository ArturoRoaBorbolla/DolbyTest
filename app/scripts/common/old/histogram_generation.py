...
# data = pd.read_csv('input\OR_1_1_4.csv')#, quoting=2)
...
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist1_1.png')
# plt.show()
...
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist1_2.png')
# plt.show()


# CSV 2:: OR_1_2_3.csv
data = pd.read_csv('C:/AIVER/Results/TEST_01/OR_1_2_3.csv')
# data = pd.read_csv('input\OR_1_2_3.csv')#, quoting=2)
data['Sum(Amount)'] = data['Sum(Amount)'].replace('[\$,]', '', regex=True).astype(float)
per_attendee_amount = data['Sum(Amount)']
...
plt.xticks([100, 500, 1000, 10000])
plt.title("Frequency Distribution Sum(Amount)", **title_font)
plt.xlabel("Sum(Amount) (USD)", **axis_font)
plt.ylabel("Frequency Count", **axis_font)
# FIXME: In HTML, Local Project Path is referred as "<img width="400" height="390" src="/AIVER/visualization/test_01/histo_4bins_wf.png">"
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist2_1.png')
# plt.show()
...
for v in enumerate(n_series):
    ...
    i = i + 50
plt.xticks([100, 150, 200, 250, 300, 350, 400, 450, 500])
plt.title("Frequency Distribution Sum(Amount) less than $500", **title_font)
plt.xlabel("Sum(Amount) (USD)", **axis_font)
plt.ylabel("Frequency Count", **axis_font)
# FIXME: In HTML, Local Project Path is referred as "<img width="400" height="390" src="/AIVER/visualization/test_01/hist_0_500_wf.png">"
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist2_2.png')
# plt.show()

# CSV 3:: OR_1_3_3.csv
data = pd.read_csv('C:/AIVER/Results/TEST_01/OR_1_3_3.csv')
# data = pd.read_csv('input\OR_1_3_3.csv')#, quoting=2)
data['Sum(Amount)'] = data['Sum(Amount)'].replace('[\$,]', '', regex=True).astype(float)
per_attendee_amount = data['Sum(Amount)']
...
plt.ylabel("Frequency Count", **axis_font)
# FIXME: In HTML, Local Project Path is referred as "<img width="400" height="390" src="/AIVER/visualization/test_01/histo_4bins_wf.png">"
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist3_1.png')
# plt.show()
...
plt.ylabel("Frequency Count", **axis_font)
# FIXME: In HTML, Local Project Path is referred as "<img width="400" height="390" src="/AIVER/visualization/test_01/hist_0_500_wf.png">"
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist3_2.png')
# plt.show()


# CSV 4:: OR_1_4_3.csv
data = pd.read_csv('C:/AIVER/Results/TEST_01/OR_1_4_3.csv')
# data = pd.read_csv('input\OR_1_4_3.csv')#, quoting=2)
...
plt.ylabel("Frequency Count", **axis_font)
# FIXME: In HTML, Local Project Path is referred as "<img width="400" height="390" src="/AIVER/visualization/test_01/histo_4bins_wf.png">"
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist4_1.png')
# plt.show()
...
plt.ylabel("Frequency Count", **axis_font)
# FIXME: In HTML, Local Project Path is referred as "<img width="400" height="390" src="/AIVER/visualization/test_01/hist_0_500_wf.png">"
plt.savefig('C:/AIVER/Dash/TestResultsForVisual/Test_01/hist4_2.png')
# plt.show()